	; CVBasic compiler v0.9.0 Jan/06/2026
	; Command: CVBasic VRAM-Check.bas VRAM-Check.asm 
	; Created: Tue Mar 10 15:28:55 2026
...
const_FIREBTNCODE:	equ $0040
	; 	CONST CHR_ROW = 32
const_CHR_ROW:	equ $0020
	; 	
	; 	CONST NUMCHIPS = 8
const_NUMCHIPS:	equ $0008
	; 	DIM CHIP(NUMCHIPS)
	; 	
	; 	CONST NUMPATTERNS = 2	'Define the number of patterns to be used in the tests
const_NUMPATTERNS:	equ $0002
	; PATTERNS:
cvb_PATTERNS:
...
cv5:
	...
	CALL nmi_on
	; 				
	; 'R=$AA	'This is only for program testing purposes
	; 'IF (#C = 12000) AND (D=1) THEN	'This is only for program testing purposes
	...
	SBC HL,DE
	JP NC,cv7
	; 							PRINT AT #N*CHR_ROW+0,"EPTN ",<.3>P," RED ",<.3>R," BIT ",<.3>X," ",<.5>#C
	LD HL,(cvb_#N)
	ADD HL,HL
	ADD HL,HL
	ADD HL,HL
...
cv32:
	...
	JP C,cv30
	; 		
	; 		PRINT AT 1,"VRAM Check by RetroChema'26 v2"
	LD HL,1
	LD (cursor),HL
	LD HL,cv33
	LD A,30
	...
	JP cv34
cv33:
	DB $56,$52,$41,$4d,$20,$43,$68,$65
	DB $63,$6b,$20,$62,$79,$20,$52,$65
	DB $74,$72,$6f,$43,$68,$65,$6d,$61
	DB $27,$32,$36,$20,$76,$32
cv34:
	; 
	; 	
	; 	END
...
cv35:
	...
	AND A
	JP NZ,cv36
	; 				PRINT AT I*CHR_ROW+64,"VRAM CHIP ",<.1>I," OK"
	LD HL,(cvb_I)
	LD H,0
	ADD HL,HL
	ADD HL,HL
...
cv40:
	...
	JP cv41
cv36:
	; 				PRINT AT I*CHR_ROW+64,"VRAM CHIP ",<.1>I," ERROR"			
	LD HL,(cvb_I)
	LD H,0
	ADD HL,HL
	ADD HL,HL
