	...
	; Created: Sun Mar 15 18:07:24 2026
...
const_CHR_ROW:	equ $0020
	; 	
	; 	CONST NUMBITS = 8
const_NUMBITS:	equ $0008
	; 	DIM BITS(NUMBITS)
	; 	
	; CHIPNAMES:
cvb_CHIPNAMES:
	; 	DATA BYTE 1,3,5,7,0,2,4,6
	DB $01,$03,$05,$07,$00,$02,$04,$06
	; 	
...
cv35:
	...
	AND A
	JP NZ,cv36
	; 				PRINT AT I*CHR_ROW+64,"CHIP UI",CHIPNAMES(I)," BIT ",<.1>I," OK"
	LD HL,(cvb_I)
	LD H,0
	ADD HL,HL
	ADD HL,HL
...
cv42:
	...
	JP cv43
cv36:
	; 				PRINT AT I*CHR_ROW+64,"CHIP UI",CHIPNAMES(I)," BIT ",<.1>I," ERROR"			
	LD HL,(cvb_I)
	LD H,0
	ADD HL,HL
	ADD HL,HL
